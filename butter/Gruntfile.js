...
var electronShell = {
  windows: {
    ...
    renamedExe:  "butter.exe",
    resources:   "resources",
    installExt:  "exe"
  },
  mac: {
    exeToRename: "Electron.app",
    renamedExe:  "butter.app",
...
function copyElectronAndBuildToRelease(build, paths) {
  grunt.log.writeln("\nCopying Electron and butter to release folder...");
...
function finalizeMacRelease(build, paths) {
  ...
  exec("defaults write " + plist + " CFBundleDisplayName butter");
  exec("defaults write " + plist + " CFBundleName butter");
